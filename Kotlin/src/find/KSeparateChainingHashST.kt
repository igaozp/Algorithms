 ...
 * @version 1.0
 */
class KSeparateChainingHashST<K, V>(private var M: Int) {
    private val INIT_CAPACITY = 4
    // 键值对总数
    private var N = 0
    // 存放链表对象的数组
    private var st = MutableList<SequentialSearchST<K, V>?>(INIT_CAPACITY, { null })
    ...
    private fun resize(chains: Int) {
        val temp = KSeparateChainingHashST<K, V>(chains)
        for (i in 0 until M) {
...
fun main(args: Array<String>) {
    val st = KSeparateChainingHashST<String, Int>(10)
